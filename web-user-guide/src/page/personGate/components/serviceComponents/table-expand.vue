<template>
  <div>
    ...
    <Row class="mt10">
      ...
      <Col span="21">
        <span class="t-orange">￥ {{parseFloat(row.setMealPrice).toFixed(2)}}</span>
        <span class="ml5 t-grey" style="text-decoration: line-through;">￥ {{parseFloat(row.totalPrice).toFixed(2)}}</span>
        <span class="ml5 t-green">￥ {{(parseFloat(row.totalPrice).toFixed(2) - parseFloat(row.setMealPrice).toFixed(2)).toFixed(2)}}</span>
      </Col>
    </Row>
    <Row class="mt10">
      <Col span="3" class="tc pr10">
