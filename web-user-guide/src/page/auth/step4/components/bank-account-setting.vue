    ...
    <div class="pt30 pl10 pr10">
        <Form ref="bankInfo" :model="bankInfo" label-position="left" :label-width="150" :rules="ruleValidate" class="pb20 pl5">
            <div class="mt20">
                ...
                <Row :gutter="32">
                    <Col span="12">
                        <Form-item prop="bankCard" label="银行卡号">
                ...
                <Row :gutter="32">
                    <Col span="12">
                        <Form-item prop="mobile" label="银行预留手机号">
                            <Input v-model="bankInfo.mobile" :maxlength="11"/>
                        </Form-item>
                    </Col>
                    <Col span="12">
    ...
    export default {
        ...
        methods: {
            ...
            changeValidate () {
                console.log('校验')
                // 手机号存在
                if (this.bankInfo.mobile || this.bankInfo.code) {
                    this.ruleValidate = {
                        mobile: [
                            { required: true, validator: isPhone, trigger: 'change' }
                        ],
            ...
            handleSubmit () {
                ...
                if (this.bankInfo.password === this.bankInfo.passwordAgain) {
                    if (this.bankInfo.mobile && !this.bankInfo.code || !this.bankInfo.mobile && this.bankInfo.code) {
                        flag = false
                        let str = ''
                        this.bankInfo.mobile ? str = '请填写验证码！' : str = '请填写手机号码！'
