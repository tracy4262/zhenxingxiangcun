...
<script>
    export default {
        ...
        methods:{
            //初始化获取收藏夹数据
            getInit(){
                this.$api.post('/member-reversion/indivi/findIndividInfo',{templateId: this.$template.id, account:this.account}).then(response => {
            ...
            saveCollections(data){
                ...
                if(this.checkCollection(data.title)){
                    this.$api.post('/member-reversion/collect/addCollect', {
