<template>
  <div class="pd20">
    ...
    <div class="mt40 pd20" style="background:#f9f9f9;">
        <Form  v-for="(item,index) in data" :key="index" :ref="`data${index}`" label-position="left" :label-width="100"  :model="item" :rules="formItemInline">
            <Row>
                <Col span="8">
                    <Form-item label="权限">
            ...
            <Row :gutter="32">
                <Col span="8">
                    <Form-item label="地块编码">
                        <Input v-model="item.landCode" :maxlength="20" readonly :disabled="!item.isAdd" @on-change="depictChange(item, index)"/>
                    </Form-item>
                </Col>
                <Col span="8">
                ...
                <Col span="8">
                    <Form-item label="检测时间">
                        <DatePicker type="date"  :disabled="!item.isAdd" v-model="item.checkTime" placeholder="请选择检测时间" readonly></DatePicker>
                    </Form-item>
                </Col>
                <Col span="8">
