...
export default {
  ...
  methods: {
    ...
    //初始化获取收藏夹数据
    handleInit(){
        this.$api.post('/member-reversion/administrationDivision/findAdministrativeDivision', {templateId: this.$template.id, user_id: this.account, year_id: this.yearId, parent_id: this.id}).then(response => {
