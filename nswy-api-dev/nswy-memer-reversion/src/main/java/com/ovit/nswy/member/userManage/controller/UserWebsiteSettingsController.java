...
@RestController
@RequestMapping("/user/websiteSettings")
public class UserWebsiteSettingsController {
    ...
    public Result saveOrUpdateWebsiteSettingsInfo(@RequestBody Map<String, Object> params) {
        ...
        try {
            ...
            updateIdentity.put("account", account);
            updateIdentity.put("flag", String.valueOf(CertificationStepEnum.STEP_COLUMNSETTINGS.getStepNum()));
            websiteSettingsService.updateIdentityFlag(updateIdentity);*/
    ...
    public Result findWebsiteSettingsInfo(@RequestBody Map<String,Object> params) {
        ...
        try {
            ...
            if (MapUtils.isNotEmpty(websiteSettingsInfo)) {
                ...
                wensiteDetailInfo.put("templateId", websiteSettingsInfo.get("template_id"));
                ...
                if (MapUtils.isNotEmpty(historyMap)) {
                    ...
                    initializeWebsiteInfo.put("templateId", templateId);
                }
