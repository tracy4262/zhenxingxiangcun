...
public class Response {
    ...
    public static Response successResult(Object result) {
        return newInstance(200, ResponseCode.OK.getDesc(),JSONHelper.toJSON(result, DateFormat.DATE_FORMAT_SEC));
    }
     ...
     * @return
     */
    public static Response newSuccessResult(Object result) {

        return newInstance(200, ResponseCode.OK.getDesc(), JSON.toJSONString(result, SerializerFeature.DisableCircularReferenceDetect));
    }
    public static Response successResult(Object result ,Integer total) {
        return newInstance(200,ResponseCode.OK.getDesc(), JSONHelper.toJSON(result, DateFormat.DATE_FORMAT_SEC),total);
    }
    ...
    public static Response successResult(int status ,Object result) {
        return newInstance(status,ResponseCode.OK.getDesc(), JSONHelper.toJSON(result, DateFormat.DATE_FORMAT_SEC));
    }

    public static Response successResult(Object result,Object msg) {
        return newInstance(200, msg, JSONHelper.toJSON(result, DateFormat.DATE_FORMAT_SEC));
    }
    ...
    public static Response convertResult(Object result ,int currentPage,int pageSize ,long total)
    {
        ...
        return newInstance(200, jsonObject, JSONHelper.toJSON(result, DateFormat.DATE_FORMAT_SEC), total);
    }
    ...
    public static Response convertResult(Object result ,int currentPage,int pageSize ,Integer totalPage)
    {
        ...
        return newInstance(200,jsonObject,JSONHelper.toJSON(result, DateFormat.DATE_FORMAT_SEC));
    }
