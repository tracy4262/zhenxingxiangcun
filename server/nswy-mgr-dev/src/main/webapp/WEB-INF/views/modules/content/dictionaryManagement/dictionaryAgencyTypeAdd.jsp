...
<form:form id="inputForm" modelAttribute="dictionaryAgencyType"  action="${ctx}/nswy/dictionaryAgencyType/save" method="post" class="form-horizontal" enctype="multipart/form-data">
