...
<ul class="nav nav-tabs">
    ...
    <li class="active">物种添加</li>
</ul>


	<form:form id="inputForm"  action="${ctx}/nswy/speciesQuery/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="speciesCode" name="speciesCode" htmlEscape="false" maxlength="50" class="required input-xlarge"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="speciesName" name="speciesName" oninput="getPinyin($('#speciesName').val())" htmlEscape="false" maxlength="50" class="required input-xlarge"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="speciesVulgo" name="speciesVulgo" htmlEscape="false" maxlength="50" class="input-xlarge"/>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="otherClassify" name="otherClassify" class="input-xlarge"/>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="findustriaclassifiedid" name="findustriaclassifiedid" class="input-xlarge"/>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="fisprotection" name="fisprotection" class="input-xlarge"/>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="majorProduct" name="majorProduct" htmlEscape="false" maxlength="50" class="input-xlarge"/>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="fshapefeatureid" name="fshapefeatureid" htmlEscape="false" maxlength="50" class="input-xlarge"/>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="remark" name="remark" htmlEscape="false" maxlength="50" class="input-xlarge"/>
