...
<form:form id="inputForm" modelAttribute="dictionaryFaith"  action="${ctx}/nswy/dictionaryFaith/save" method="post" class="form-horizontal" enctype="multipart/form-data">
