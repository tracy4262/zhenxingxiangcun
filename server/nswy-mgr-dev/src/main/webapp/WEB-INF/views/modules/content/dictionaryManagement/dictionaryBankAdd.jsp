...
<form:form id="inputForm" modelAttribute="dictionaryBank"  action="${ctx}/nswy/dictionaryBank/save" method="post" class="form-horizontal" enctype="multipart/form-data">
