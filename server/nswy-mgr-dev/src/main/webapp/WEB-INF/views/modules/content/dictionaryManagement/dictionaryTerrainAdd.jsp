...
<form:form id="inputForm" modelAttribute="dictionaryTerrain"  action="${ctx}/nswy/dictionaryTerrain/save" method="post" class="form-horizontal" enctype="multipart/form-data">
