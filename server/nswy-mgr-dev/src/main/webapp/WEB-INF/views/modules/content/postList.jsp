...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/nswy/post/control/">职务列表</a></li>
	...
	<script type="text/template" id="treeTableTpl">
		<tr id="{{row.id}}" pId="{{pid}}">
			...
			<shiro:hasPermission name="sys:area:edit"><td>
				<a href="${ctx}/nswy/post/addPid?pid={{row.pid}}">添加同级职务</a>
				<a href="${ctx}/nswy/post/add?id={{row.id}}">添加子级职务</a>
				<a href="${ctx}/nswy/post/form?id={{row.id}}">修改</a>
				<a href="${ctx}/nswy/post/delete?id={{row.id}}" onclick="return confirmx('是否删除该职务信息？', this.href)">删除</a>
