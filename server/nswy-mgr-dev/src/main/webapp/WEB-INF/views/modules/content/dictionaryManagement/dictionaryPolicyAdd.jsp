...
<form:form id="inputForm" modelAttribute="dictionaryPolicy"  action="${ctx}/nswy/dictionaryPolicy/save" method="post" class="form-horizontal" enctype="multipart/form-data">
