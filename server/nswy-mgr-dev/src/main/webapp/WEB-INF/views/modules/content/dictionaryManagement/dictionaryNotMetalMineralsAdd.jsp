...
<form:form id="inputForm" modelAttribute="dictionaryNotMetalMinerals"  action="${ctx}/nswy/dictionaryNotMetalMinerals/save" method="post" class="form-horizontal" enctype="multipart/form-data">
