...
<form:form id="inputForm" modelAttribute="dictionaryInformation"  action="${ctx}/nswy/dictionaryInformation/save" method="post" class="form-horizontal" enctype="multipart/form-data">
