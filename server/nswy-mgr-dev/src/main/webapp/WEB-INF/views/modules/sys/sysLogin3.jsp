...
<head>
    ...
    <style type="text/css">
        html,body,table{background:url(../../../../static/images/banner.png) no-repeat;background-size: 100% 86%; /*background-color:#f5f5f5;*/width:100%;text-align:center;}.form-signin-heading{font-family:Helvetica, Georgia, Arial, sans-serif, 黑体;font-size:36px;margin-bottom:20px;color:#0663a2;}
