...
<form:form id="inputForm" action="${ctx}/nswy/serviceType/save" method="post" class="form-horizontal"
           enctype="multipart/form-data">

    <div class="control-group">
        <label class="control-label">服务名称:</label>
        <div class="controls">
            <input type="text" id="dictName" name="dictName" htmlEscape="false" maxlength="50"
