...
<form:form id="inputForm" modelAttribute="dictionaryKnowledge"  action="${ctx}/nswy/dictionaryKnowledge/save" method="post" class="form-horizontal" enctype="multipart/form-data">
