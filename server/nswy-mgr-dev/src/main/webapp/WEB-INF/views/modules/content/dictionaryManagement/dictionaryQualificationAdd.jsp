...
<form:form id="inputForm" modelAttribute="dictionaryQualification"  action="${ctx}/nswy/dictionaryQualification/save" method="post" class="form-horizontal" enctype="multipart/form-data">
