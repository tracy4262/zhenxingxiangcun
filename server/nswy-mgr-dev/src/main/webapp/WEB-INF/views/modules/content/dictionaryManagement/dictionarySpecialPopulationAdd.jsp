...
<form:form id="inputForm" modelAttribute="dictionarySpecialPopulation"  action="${ctx}/nswy/dictionarySpecialPopulation/save" method="post" class="form-horizontal" enctype="multipart/form-data">
