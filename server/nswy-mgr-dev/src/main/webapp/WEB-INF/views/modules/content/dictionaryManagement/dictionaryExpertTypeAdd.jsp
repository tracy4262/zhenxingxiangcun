...
<form:form id="inputForm" modelAttribute="dictionaryExpertType"  action="${ctx}/nswy/dictionaryExpertType/save" method="post" class="form-horizontal" enctype="multipart/form-data">
