...
<body>
<form:form id="searchForm"  modelAttribute="speciesInfo"  action="${ctx}/nswy/getSpeciesPestList" method="post" class="breadcrumb form-search">
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
	<tr><th>虫害名称</th><th>汉语拼音</th><th>审核状态</th><th>更新时间</th><th>创建者</th><shiro:hasPermission name="sys:role:edit"><th>操作</th></shiro:hasPermission></tr>
	<c:forEach items="${page.list}" var="item">
		<tr>
			<td><a href="${ctx}/nswy/speciesPestForm?indexid=${item.indexid}">${item.fname}</a></td>
			<td><a href="${ctx}/nswy/speciesPestForm?indexid=${item.indexid}">${item.fpinyin}</a></td>
			<c:choose>
			...
			<td>
				<a href="${ctx}/nswy/speciesPestForm?indexid=${item.indexid}">查看</a>
			</td>
		</tr>
	</c:forEach>
</table>
