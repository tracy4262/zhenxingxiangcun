...
<form:form id="inputForm" modelAttribute="dictionaryCategory"  action="${ctx}/nswy/dictionaryCategory/save" method="post" class="form-horizontal" enctype="multipart/form-data">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" id="name"  name="name" oninput="getPinyin($('#name').val())" htmlEscape="false" maxlength="50" class="required input-xlarge"/>
