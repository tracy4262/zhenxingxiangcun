...
<form:form id="inputForm"  modelAttribute="dictionaryEnvironment" action="${ctx}/nswy/dictionaryEnvironment/updateEnvironment" method="post" class="form-horizontal" enctype="multipart/form-data">
	<form:hidden path="id"/>
