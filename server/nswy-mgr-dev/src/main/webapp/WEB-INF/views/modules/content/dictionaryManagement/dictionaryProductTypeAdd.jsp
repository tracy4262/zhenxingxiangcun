...
<form:form id="inputForm" modelAttribute="dictionaryProductType"  action="${ctx}/nswy/dictionaryProductType/save" method="post" class="form-horizontal" enctype="multipart/form-data">
