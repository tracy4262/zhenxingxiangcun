...
<form:form id="inputForm" modelAttribute="dictionaryRightType"  action="${ctx}/nswy/dictionaryRightType/save" method="post" class="form-horizontal" enctype="multipart/form-data">
