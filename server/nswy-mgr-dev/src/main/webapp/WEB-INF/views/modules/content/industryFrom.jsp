...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/nswy/industry/form/">行业修改</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="industryInfo" action="${ctx}/nswy/industry/updateIndustry" method="post" class="form-horizontal">
		<form:hidden path="id"/>
