...
<form:form id="inputForm" modelAttribute="dictionaryLandform"  action="${ctx}/nswy/dictionaryLandform/save" method="post" class="form-horizontal" enctype="multipart/form-data">
