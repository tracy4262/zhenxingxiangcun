                    ...
                    <Checkbox-group v-model="choosed">
                        <i-col span="4" v-for="(item,index) in resultDatas" :key="index">
                            <figure>
                                ...
                                <img :src="'http:'+item.src" style="width: 110px; height: 110px; margin-left: 10px; margin-top: 10px;">
                            </figure>
                        </i-col>
                    </Checkbox-group>
                </Row>
            ...
            <div class="photo-selected">
                <Row>
                    <i-col span="4" v-for="(item,index) in choosed" :key="index">
                        <figure>
                            <img :src="'http:'+item" style="width: 110px; height: 110px; margin-left: 10px; margin-top: 10px;">
                        </figure>
                    </i-col>
                </Row>
            </div>
