  ...
  <div class="articles-ivu pd20">
      <Row type="flex" justify="center">
          <Col span="16">
            ...
            <Avatar v-else src="./static/imgs/user-icon-big.png" width="32" height="31" class="list-avatar"/>
      ...
      <div class="pics" v-if="data.columnType == '图册'">
          <Row :gutter="8" class="pb10">
              <Col span="6" v-for="(item, index) in data.imgContent" :key="index">
                    <img :src="item" width="100%" height="94px" v-if="item">
              </Col>
          </Row>
      </div>
      <!-- 视频列表 -->
          ...
          <Row>
              <Col span="16">
                ...
                <Button type="text" @click="fabulous(data.id)">
                    ...
                    <Icon type="thumbsup" size="16"></Icon>
...
<script>
    /* eslint-disable */
    import comment from './vui-comments/item.vue'
    export default {
        components:{            
			comment
        },
