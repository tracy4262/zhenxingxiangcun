...
<div>
  ...
  <!-- 相关物种 -->
  <vui-filter ref="filter" :num="num" :cols="1" :pageShow="true" :total="total" :pageCur="pageCur" :classifyDatas="classifyDatas" :resultDatas="resultDatas" :load-data="loadDatas" @on-search="handleSearch" @on-get-classify="handleGetClassify" @on-get-result="handleGetResult"
