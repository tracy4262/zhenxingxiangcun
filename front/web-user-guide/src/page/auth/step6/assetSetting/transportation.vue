          ...
          <Row :gutter="16">
              ...
              <Col span="8">
                  <Form-item prop="modelCategory" label="车型类别">
                      <Input v-model="item.modelCategory" :maxlength="20" :disabled="!item.edit">
                      </Input>
                  </Form-item>
              </Col>
              <Col span="8">
                  <Form-item prop="displacement" label="排量">
                      <Input v-model="item.displacement" :maxlength="20" :disabled="!item.edit">
          ...
          <Row :gutter="16">
              <Col span="8">
                  <Form-item prop="maximumPower" label="最大功率">
                     <Input v-model="item.maximumPower" :maxlength="20" :disabled="!item.edit">
               ...
               <Col span="8">
                  <Form-item prop="loadingWeight" label="装载重量">
                     <Input v-model="item.loadingWeight" :maxlength="20" :disabled="!item.edit">
           ...
           <Row :gutter="16">
              <Col span="8">
                  <Form-item prop="maximumPowerSpeed" label="最大功率转速">
                     <Input v-model="item.maximumPowerSpeed" :maxlength="20" :disabled="!item.edit">
               ...
               <Col span="8">
                  <Form-item prop="maximumTorque" label="最大扭矩">
                     <Input v-model="item.maximumTorque" :maxlength="20" :disabled="!item.edit">
               ...
               <Col span="8">
                  <Form-item prop="maximumTorqueSpeed" label="最大扭矩转速">
                     <Input v-model="item.maximumTorqueSpeed" :maxlength="20" :disabled="!item.edit">
    ...
    handleInit (type) {
        this.$api.post('/member-reversion/assetSeting/findTransportationToolsInfo',{
            ...
            if (!response.data.textPreview.textPreview) {
                response.data.textPreview.textPreview =  `权利人姓名（），通用名称（），品牌名称（），型号（），车型类别（），排量（）ml，最大功率（）KW，最大马力（）Ps，装载总量（），最大功率转速（）rpm，最大扭矩（）N.m，最大扭矩转速（），数量（），单价（）元，总值（）元。`
            }
