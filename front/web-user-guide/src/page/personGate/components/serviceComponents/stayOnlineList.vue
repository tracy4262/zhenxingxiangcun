          ...
          <Row :gutter="8">
            ...
            <div class="pd20" style="border:1px solid #e8e8e8"  ref="orderRight" :style="{'min-height': orderRightHeight}">
              ...
              <Row :gutter="8" class="pb10" type="flex" align="middle">
                ...
                <Col span="19">{{packageData.contact_name}}</Col>
              </Row>
              <Row :gutter="8" class="pb10" type="flex" align="middle">
                <Col span="5"  class="lable"><b>联系电话：</b></Col>
                <Col span="19">{{packageData.phone}}</Col>
              </Row>
              <Row :gutter="8" class="pb10" type="flex" align="middle">
  ...
  export default {
        ...
        roomColumns: [
            ...
            // },
          {
              ...
              render: (h, params) => {
                return h('Button', {
                      props: {
                        type: params.row.checked ? 'primary' : '',
                        size: 'small'
                      },
                      on: {
                        click: () => {
    ...
    methods: {
      ...
      handleOk () {
        ...
        // console.log('dateDatasdateDatasdateDatasdateDatasdateDatas' ,this.dateDatas)
        // console.log('foodDatafoodDatafoodDatafoodDatafoodDatafoodDatafoodDatafoodDatafoodData' ,this.foodData)
