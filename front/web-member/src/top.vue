                ...
                <div style="width: 1200px; margin: auto;">
                    <Row type="flex" align="middle" class="top-nav">
                            ...
                            <Col span="10" offset="7" class="ns-nav pl10">
                                ...
                                <Col span="4" offset="1">
                                    <router-link to="/51index" :class="{'ns-active': active === '1'}">
                                        无忧首页
                                    </router-link>
                                </Col>
                                <Col span="4" offset="1">
                                    <router-link to="/mapNav" :class="{'ns-active': active === '2'}">
                                        地图导航
                                    </router-link>
                                </Col>
                                <Col span="4" offset="1">
                                    <a href="/pocket" :class="{'ns-active': active === '3'}">
                                        掌上无忧
                                    </a>
                                </Col>
                                <Col span="4" offset="1">
                            ...
                            <Col span="4" v-if="loginuserinfo" class="tr">
                                <a>
                                    ...
                                    <Avatar src="../../static/img/user-icon-big.png" class="cus" v-else />
                                </a>
...
export default {
    ...
    beforeCreate () {
        if (this.$route.query.type && this.$route.query.type === 'proxy') {
            sessionStorage.removeItem('key')
            sessionStorage.setItem('key', this.$route.query.uid)
            window.location.href = `${window.location.origin}/pro/member?uid=${this.$route.query.uid}`
        }
    },
    created () {
        ...
        isLogin(e){
            ...
            if(user === null){
                ...
                if (e === 'iswho') {
                    ...
                    this.$router.push(`${e}?uid=${this.$user.loginAccount}`)
                }
            }
        },
        // 高级搜索
