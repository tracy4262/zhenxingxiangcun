    ...
    <div>
        <div class="layouts">
            <Row>
                ...
                <div>
                    <div class="ma_infor_h">最新资讯</div>
                    <recommend :newData="inforMationData"></recommend>
                </div>
                <div>
                    <div class="ma_infor_h mt50">最新政策</div>
