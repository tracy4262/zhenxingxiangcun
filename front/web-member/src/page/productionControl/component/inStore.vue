  ...
  <Modal v-model="modalShow" width="1200" :mask-closable="false" title="入库" :styles="{top: '60px'}">
    <div>
      ...
      <div class="tc mt20">
        ...
        <Button type="primary" class="ml10" @click="saveStore(0)">保存</Button>
...
export default {
  ...
  methods: {
    ...
    initAdd (productCode) {
      ...
      this.info.productCode = productCode
      this.initProductCode(productCode)
      this.modalShow = true
    },
    // 初始化产品编码
    initProductCode (productCode) {
