...
export default {
	...
	methods: {
		preStep(){
			...
			this.$router.push({ path: "/pro/member/progress6/progress7/progress11"})
		},
		pass(){
			let type=this.$route.meta.type
			if(1 === type){
				this.$parent.$parent.$parent.$parent.gotoPathSec(13)
			}else{
				this.$parent.$parent.$parent.$parent.gotoPath(13)
			}
		},
		changeColor() {
