<template>
    <div>
        ...
        <div class="nav-gate-rural" :class="active == '0/index' ? 'nav-gate-position' : ''">
          <div class="layouts">
...
export default {
    ...
    data () {
        return {
            ...
            data:[{
                title: '首页',
                url: '/ruralPortal/index',
                checked: true,
                isShow: true
            },{
                title: '乡村介绍',
                url: '/ruralPortal/Introduction',
                checked: false,
                isShow: true
            }, {
                title: '乡村动态',
                url: '/ruralPortal/dynamic',
                checked: false,
                isShow: true
            }, {
                title: '乡村政策',
                url: '/ruralPortal/policy',
                checked: false,
                isShow: true
            }, {
                title: '乡村知识',
                url: '/ruralPortal/knowledge',
                checked: false,
                isShow: true
            }, {
                title: '标准',
                url: '/ruralPortal/standard',
                checked: false,
                isShow: true
            }, {
                title: '会员产品',
                url: '/ruralPortal/product',
                checked: false,
                isShow: true
            }, {
                title: '会员服务',
                url: '/ruralPortal/service',
                checked: false,
                isShow: true
            }, {
                title: '基地',
                url: '/ruralPortal/productionBase',
                checked: false,
                isShow: true
            },
            {
                title: '联系我们',
                url: '/ruralPortal/contact',
                checked: false,
                isShow: true
            }],
            loginAccount:'',
    ...
    methods:{
        ...
        clickTab (attributionId) {
            ...
            if (attributionId.split('/').length > 2) {
                this.$router.push(`/ruralPortal/${attributionId.split('/')[1]}?uid=${this.$route.query.uid}&tabType=${attributionId.split('/')[2]}&id=${attributionId.split('/')[0]}`)
            } else {
                this.$router.push(`/ruralPortal/${attributionId.split('/')[1]}?uid=${this.$route.query.uid}&id=${attributionId.split('/')[0]}`)
            }
        },
        toIntroduction () {
            ...
            this.data.forEach((e, index) => {
                if (e.attributionId == `${index}/${this.active}`) {
                    ...
                    this.$router.push(`/ruralPortal/introduction?uid=${this.loginAccount}&id=${index}`)
                }
            })
        },
        useqrcode () {
...
.nav-gate-rural.nav-gate-position{
    margin-top: -50px;
