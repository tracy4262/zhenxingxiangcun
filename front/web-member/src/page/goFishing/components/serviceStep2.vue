    ...
    <div class="add-service">
        <Form ref="data1" :model="data" :label-width="120"   label-position="left" :rules="ruleInline" >
            <FormItem label="服务名称" prop="service_name">
                <Input v-model="data.service_name" :maxlength="20"></Input>
            </FormItem>
            <FormItem label="简单描述">
            ...
            <FormItem label="服务介绍" prop="service_describe">
    ...
    <div class="add-service">
        <Form ref="data2" :model="data" :label-width="120"   label-position="left" :rules="ruleInline" >
            <!-- <FormItem label="联系人" prop="contact_name">
                <Input v-model="data.contact_name" :maxlength="20"></Input>
            </FormItem>
            <FormItem label="QQ"  prop="qq_number">
                <Input v-model="data.qq_number" :maxlength="20"></Input>
            </FormItem>
            <FormItem label="联系电话" prop="phone">
                <Input v-model="data.phone" :maxlength="11"></Input>
            </FormItem>
            <FormItem label="联系邮箱" prop="email">
                <Input v-model="data.email" :maxlength="50"></Input>
            </FormItem>
            <FormItem label="联系地址">
            ...
            <!-- <FormItem label="经纬度">
                <Row>
                    <Col span="18"><Input v-model="data.coordinate" readonly/></Col>
                    <Col span="6" class="pl15">
                        <Button @click="onSelectPoint" >定位</Button>
                    </Col>
                </Row>
            </FormItem> -->
            <FormItem label="垂钓品种">
             ...
             <FormItem label="垂钓季节">
               <Input v-model="data.season" placeholder="例如：3月至9月"/>
            </FormItem>
    ...
    <div class="add-service">
        <Form ref="data3" :model="data" :label-width="120"  label-position="left" :rules="ruleInline" >
            ...
            <!-- <FormItem label="选择交通引导">
                <Input type="textarea" :autosize="{minRows: 3,maxRows: 5}" v-model="data.traffic_lead" :maxlength="200"></Input>
            </FormItem> -->
        </Form>
        <div class="tc pt20">
...
<script>
    ...
    import selectBusinessOutlet from './selectBusinessOutlet'
    import selectBusinessOutletCard from './selectBusinessOutletCard'
    ...
    export default {
        ...
        methods:{
                ...
                if (flag) {
                    this.$api.post('/member/fishing/updateFishingService',this.data).then(response=>{
                        if(response.code == 200){
                            ...
                            this.$router.push(`/addService/step3?id=${this.data.id}`)
                        }
                    })   
                } else {
                    this.$Message.error('请核对输入信息!');
            ...
            // 上一步
            handleBack () {
                this.$router.push('/addService/step1?id='+this.data.id)
            },
            //获取上传图片
            getPictureList(e){
                var arr = []
