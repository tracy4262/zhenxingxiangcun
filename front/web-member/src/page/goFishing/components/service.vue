<template>
    <div class="pd30">
        <Row class="pt20 pb20">
            <Col span="12">
                <Input v-model="keyWord" icon="ios-search" placeholder="请输入关键字" style="width: 200px" @on-enter="handleSearch" @on-click="handleSearch"></Input>
            </Col>
...
export default {
    ...
    methods:{
        ...
        handleEdit (id) {
            console.log(id)
            this.$router.push(`/addService/step1?id=${id}`)
        },
        //查询
        handleSearch (){
            this.handleInit(1)
        ...
        //添加服务
        handleAdd (){
            this.$router.push('/addService/step1')
        }
    }
}
</script>
