<template>
    <div class="pt30 pl10 pr10">
        <Form ref="data" :model="data" label-position="left" :label-width="150" :rules="ruleInline">
            ...
            <view-panel title="添加自定义字段"  v-if="data.customData && data.customData.length" :edit="false" :data="data.customData" @on-data="handleGetSafeForm" @on-add="handleAddBtn"></view-panel>
        </Form>
