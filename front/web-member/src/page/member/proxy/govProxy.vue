                ...
                <Row :gutter="20">
                    <Col span="24">
                        <div>
                            ...
                            <div>
                                <h3 style="margin-top: 20px;">成为机关用户代理人</h3>
                                <div style="margin-left: 200px; margin-top: 30px;height: 95px;overflow: hidden;">
                                ...
                                <div style="display: flex; justify-content: center; align-items: center; margin-bottom: 20px;" v-if="step2">
                                    <div align="center" style="margin-left: 15%;margin-right: 15%">
                                        ...
                                        <h4 style="color: #666666; margin-top: 20px;">
                                            <span>您已提交机关代理信息，审核工作将在</span><br>
        ...
        data() {
            return {
                ...
                ruleInline: {
                    ...
                    gov_domicile: [
                        { required: true, message: '请填写机关住所', trigger: 'blur' }
                    ],
                    credit_code: [
