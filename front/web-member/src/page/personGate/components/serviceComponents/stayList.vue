           ...
           <Row :gutter="8" v-if="checkedData[0]">
            ...
            <div class="pd20" style="border:1px solid #e8e8e8" ref="orderRight" :style="{'min-height': orderRightHeight}">
              ...
              <Row :gutter="8" class="pb10" type="flex" align="middle">
                ...
                <Col span="19"> {{moment(checkedData[0].userTime).format('YYYY-MM-DD')}}</Col>
              </Row>
              <Row :gutter="8" class="pb10" type="flex" align="middle">
        ...
        this.data.forEach(element => {
          if (element.checked) {
            if (element.date) {
              ...
              element.userTime = this.moment(element.userTime).format('YYYY-MM-DD')
            } else {
              this.$Message.error('请选择住宿日期')
              flag =  false
            }
        ...
        if (flag) {
          if (!this.checkedData.length) {
            ...
            let data = {
              ...
              userTime: this.moment(this.checkedData[0].userTime).format('YYYY-MM-DD'),
