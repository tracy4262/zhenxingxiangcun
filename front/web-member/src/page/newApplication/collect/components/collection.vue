    ...
    <div class="pt10 pl10 pr10 pb20">
        <Row>
            ...
            <Col span="12" class="tr">
                <Button type="primary" style="margin-right: 25px;" @click="handleAddCollection"><Icon type="md-add"></Icon>增加</Button>
            </Col>
        </Row>
        <Tree v-if="data.length !== 0" :data="data" :render="renderContent" class="collection-tree mt20"></Tree>
    </div>
</template>
<script>
    export default {
