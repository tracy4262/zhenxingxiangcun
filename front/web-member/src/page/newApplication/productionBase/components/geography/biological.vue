      ...
      <Row  :gutter="40">
        <Col span="12">
            ...
            <Row  :gutter="16" class="pb20">
              ...
              <Col span="11"> 
                  <Input v-model="animalLists" readonly 
                  class="pinput-clear" 
            ...
            <Row  :gutter="16" class="pb20" v-for="(item, index) in animalList" :key="index">
              ...
              <Col span="11"> 
                <Select v-model="item.animalName" multiple @on-change="changePreview">
                    <Option v-for="item in animalData" :value="item.label" :key="item.label">{{ item.label }}</Option>
                </Select>
              </Col>
              <Col span="2"> <Button @click="animalDel(item, index)" v-if="index > 1">删除</Button> </Col>
            </Row>
         ...
         <Col span="12">
            ...
            <Row  :gutter="16" class="pb20">
              ...
              <Col span="11"> 
                  <Input v-model="plantLists" readonly 
                    class="pinput-clear" 
            ...
            <Row  :gutter="16" class="pb20" v-for="(item, index) in plantList" :key="index">
              <Col span="9" v-if="index > 1"> 
              ...
              <Col span="11"> 
                <Select v-model="item.plantName" multiple  @on-change="changePreview">
                    <Option v-for="item in plantData" :value="item.label" :key="item.label">{{ item.label }}</Option>
                </Select>
              </Col>
              <Col span="2"> <Button @click="plantDel(item, index)" v-if="index > 1">删除</Button> </Col>
            </Row>
...
export default {
  ...
  methods: {
    ...
    //初始化取数据
    handleInit () {
      this.$api.post('/member-reversion/productionBase/physicalGeography/findBiologicalResources', {
    ...
    handleSave () {
      ...
      this.loading = true
      this.$api.post('/member-reversion/productionBase/physicalGeography/saveBiologicalResources', list).then(response => {
        if (response.code === 200) {
          this.$emit('on-save')
