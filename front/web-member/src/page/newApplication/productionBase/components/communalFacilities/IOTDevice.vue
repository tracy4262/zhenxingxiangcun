...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 初始化加载数据
            init (type = 0) {
                this.$api.post('/member-reversion/productionBase/communalFacilities/findIotDeviceInfo', {
                    account: this.$user.loginAccount,
                ...
                this.$Modal.confirm({
                    ...
                    onOk:()=>{
                        if (item.id !== undefined && item.id !== '') {
                            this.$api.post('/member-reversion/productionBase/communalFacilities/deleteIotDeviceInfo', {
                                id: item.id
                            }).then(response => {
            ...
            save (item, index) {
                ...
                this.$api.post('/member-reversion/productionBase/communalFacilities/saveIotDeviceInfo', data).then(response => {
