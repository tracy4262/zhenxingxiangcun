...
<script>
import {eleAttr} from '../../goods/components/vui-form-control/components/mixins'
import Title from '../../goods/components/vui-form-control/components/title'
import eleInput from '../../goods/components/vui-form-control/components/input'
export default {
  mixins: [eleAttr],
  components: {
    Title,
