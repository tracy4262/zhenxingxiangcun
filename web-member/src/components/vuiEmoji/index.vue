<template>
  <div style="display:inline-block;position:relative;">
    <i class="ivu-icon" :class="iconName" :style="{'font-size': iconSize, 'color': iconColor}" @click="panelShow=!panelShow"></i>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      iconName () {
        return this.iconConfig.name === undefined ? 'ivu-icon-happy-outline' : this.iconConfig.name
      },
      iconColor () {
