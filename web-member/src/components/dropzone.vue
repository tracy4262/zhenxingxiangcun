...
<script>
    export default {
        ...
        computed: {
            languageSettings () {
                let defaultValues = {
                    dictDefaultMessage          : '<br>选择上传文件',
                    dictCancelUpload            : '取消上传',
                    dictCancelUploadConfirmation: '您确定要取消此上传吗?',
                    dictFallbackMessage         : '您的浏览器不支持拖放文件上传。',
                    dictFallbackText            : 'Please use the fallback form below to upload your files like in the olden days.',
                    dictFileTooBig              : '文件大小 ({{filesize}}MiB). 最大: {{maxFilesize}}MiB.',
                    dictInvalidFileType         : `你不能上传这种类型的文件。`,
                    dictMaxFilesExceeded        : '你不能上传更多的文件，最多可传 (max: {{maxFiles}})个',
                    dictRemoveFile              : '移除',
                    dictRemoveFileConfirmation  : null,
                    dictResponseError           : '服务器响应状态 {{statusCode}}.'
                };
            ...
            cloudIcon: function () {
                return '<i class="ivu-icon ivu-icon-android-camera upload-icon"></Icon>';
            },
            doneIcon: function () {
                return '<i class="ivu-icon ivu-icon-checkmark-circled"></Icon>';
            },
            errorIcon: function () {
                return '<i class="ivu-icon ivu-icon-close-circled"></Icon>';
            }
        },
        mounted () {
            if (this.$isServer) {
