 ...
 * @param id
 */
const TreeNode = function (name, isLeaf,remark,id) {
  this.name = name
  this.id = (typeof id === 'undefined') ? (1+nodeId++) : id
  this.parent = null
  this.pid = 0
  this.children = null
  this.isLeaf = !!isLeaf
...
TreeNode.prototype.updateRecordProperty = function () {
  ...
  Record[this.id].remark = this.remark
}
...
TreeNode.prototype.changeRemark = function (remark) {
  this.remark = remark
