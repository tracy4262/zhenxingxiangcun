...
export default {
	...
	methods: {
		preStep(){
			...
			this.$router.push({ path: "/pro/member/progress6/progress7/progress10"})
		},
		pass(){
			let type=this.$route.meta.type
			if(1 === type){
				this.$parent.$parent.$parent.$parent.gotoPathSec(12)
			}else{
				this.$parent.$parent.$parent.$parent.gotoPath(12)
			}
		},
		changeKnow(e) {
			var _this = this
