          ...
          <Row>
            <Col span="22">
              ...
              <RadioGroup
                ...
                <Radio :label="child.value" :disabled="item.disabled || disabled" :key="child.value" v-for="child in item.list"></Radio>
              </RadioGroup>
              ...
              <CheckboxGroup
                ...
                v-model="item.value">
                <Checkbox :label="child.value" :disabled="item.disabled || disabled" :key="child.value" v-for="child in item.list"></Checkbox>
              </CheckboxGroup>

              <!-- 开关 -->
              <Switch v-model="item.value" size="large" v-if="item.type === 'switch'" :disabled="item.disabled || disabled">
