...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            init () {
                this.$api.post('/member-reversion/productionBase/envCondition/findAirQuality', {
                    account: this.$user.loginAccount,
                    baseId: this.baseId,
                    dictId: this.modeId
                }).then(response => {
                    console.log('air res', response)
                    if (response.code === 200) {
            ...
            handleSave () {
                ...
                this.$api.post('/member-reversion/productionBase/envCondition/modifyAirQuality', data).then(response => {
                    if (response.code === 200) {
