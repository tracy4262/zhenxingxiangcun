...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 初始化加载数据
            init (type = 0) {
                this.$api.post('/member-reversion/productionBase/communalFacilities/findTapWaternFacilitiesInfo', {
                    account: this.$user.loginAccount,
                ...
                this.$Modal.confirm({
                    ...
                    onOk:()=>{
                        if (item.id !== undefined && item.id !== '') {
                            this.$api.post('/member-reversion/productionBase/communalFacilities/deleteTapWaternFacilitiesInfo', {
                                id: item.id
                            }).then(response => {
            ...
            save (item, index) {
                ...
                this.$api.post('/member-reversion/productionBase/communalFacilities/saveTapWaternFacilitiesInfo', data).then(response => {
