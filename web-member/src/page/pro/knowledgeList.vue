        ...
        <div class="layouts">
            <Row>
                ...
                <div v-if="dataList.length == 0 && isShow" class="tc pt30 pb50">
                    ...
                    <p style="margin-top: 10px;">暂无相关知识</p>
                </div>
                &nbsp;
                </Col>
                <Col span="4" offset="1">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getInforMationData() {
                let that = this;
                api.get('/member/inforMation/newinfo')
                    .then(res => {
                        if (res.code === 200) {
