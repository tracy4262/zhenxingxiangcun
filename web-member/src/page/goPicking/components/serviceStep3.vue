    ...
    <div class="add-service" style="width:1100px;">
        <Form :label-width="120">
            <FormItem label="收费方式" prop="chargingMethod">
                <Row>
                    <Col span="4"><Checkbox v-model="data.timeVariety">按采摘品种收费</Checkbox></Col>
                ...
                <Row>
                    <Col span="12">
                        <FormItem label="采摘季节" prop="season">
                            <Input v-model="productInfo.season" readonly/>
                        </FormItem>
                    </Col>
                    <Col span="12">
                        <Form-item prop="fishType" label="采摘状态">
...
import vuiUnit from '~components/vui-unit'
    export default {
        ...
        methods:{
                    ...
                    if (flag) {
                        this.$api.post('/member/fishing/updateFishingService',this.data).then(response=>{
                            if(response.code == 200){
                                ...
                                this.$router.push(`/pickingAddService/step4?id=${this.data.id}`)
                            }
                        })
                    }
                }
            ...
            // 上一步
            handleBack () {
                this.$router.push('/pickingAddService/step2?id='+this.data.id)
            },
        }
    }
</script>
