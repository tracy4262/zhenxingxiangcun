<template>
    <div>
        <div class="perService" v-if="serverData.length > 0">
            ...
            <Page class="mt30 country tc pb50" :page-size="pageSize" :total="total" :current="current" @on-change="handleChangePage"></Page>
        </div>
...
export default {
    name: 'person-service-scenic-spot',
    components: {
        serverItem
    },
    data () {
