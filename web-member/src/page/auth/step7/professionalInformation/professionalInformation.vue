  ...
  <div class="pd20">
    ...
    <!-- <Form ref="formItem" :model="form" label-position="left" :label-width="100" :rules="formItemInline" class="mt40">
        ...
        <Row :gutter="32">
            <Col span="8">
                <FormItem label="专家分类">
                    <Select v-model="form.expertType" @on-change="change">
            ...
            <Col span="8">
                <FormItem label="职称">
                    <Input v-model="form.title" readonly class="pinput-clear" @on-focus="handleFilterModal('zhichengFilter')" icon="ios-close-circle" @on-click="inputClear('zhichengFilter')" @on-change="change" />
                </FormItem>
            </Col>
            <Col span="8">
                <FormItem label="擅长领域">
                    <Input v-model="form.excelField" clearable @on-change="change" />
                </FormItem>
            </Col>
        </Row>
        <Row :gutter="32">
            <Col span="8">
                <FormItem label="擅长物种">
                    <Input v-model="form.excelSpecies" readonly class="pinput-clear" @on-focus="handleFilterModal('speciFilter2')" icon="ios-close-circle" @on-click="inputClear('speciFilter2')" @on-change="change" />
                </FormItem>
            </Col>
            <Col span="8">
                <FormItem label="相关物种">
                    <Input v-model="form.relatedSpecies" readonly class="pinput-clear" @on-focus="handleFilterModal('speciFilter')" icon="ios-close-circle" @on-click="inputClear('speciFilter')" @on-change="change" />
                </FormItem>
            </Col>
            <Col span="8">
                <FormItem label="相关行业">
                    <Input v-model="form.relatedIndustries" readonly class="pinput-clear" @on-focus="handleFilterModal('tradeFilter')" icon="ios-close-circle" @on-click="inputClear('tradeFilter')" @on-change="change" />
                </FormItem>
            </Col>
        </Row>
        <Row :gutter="32">
            <Col span="8">
                <FormItem label="相关商品">
                    <Input v-model="form.relatedGoods" clearable @on-change="change" />
                </FormItem>
            </Col>
            <Col span="8">
                <FormItem label="相关服务">
                    <Input v-model="form.relatedServices" readonly class="pinput-clear" @on-focus="handleFilterModal('serviceFilter')" icon="ios-close-circle" @on-click="inputClear('serviceFilter')" @on-change="change" />
                </FormItem>
            </Col>
        </Row>
        ...
        <Form :ref="`formItem${index}`" :model="item" label-position="left" :label-width="100" :rules="formItemInline">
            ...
            <Row :gutter="32">
                <Col span="12">
                    <FormItem label="专家姓名" prop="expertName">
                        <Input v-model="item.expertName" :clearable="item.isAdd" @on-change="change" :disabled="!item.isAdd" />
                    </FormItem>
                </Col>
                <Col span="12">
            ...
            <FormItem label="上传个人照片" prop="personalPicture">
                <vui-upload
                    ...
                    :total="1"
                ></vui-upload>
                <div v-show="!item.isAdd" v-for="(pic, index) in item.personalPicture" :key="index">
                    <img :src="pic" style="width: 140px; height: 140px; float: left; margin-right: 10px;">
                </div>
            </FormItem>
            <Row :gutter="32">
                <Col span="12">
                    <FormItem label="职称" prop="title">
                        <Input v-model="item.title" :disabled="!item.isAdd" readonly class="pinput-clear" 
            ...
            <FormItem label="上传资质证书" prop="qualificationsPicture">
                <vui-upload
                    ...
                    :total="9999999"
                ></vui-upload>
                <div v-show="!item.isAdd" v-for="(pic, index) in item.qualificationsPicture" :key="index">
                    <img :src="pic" style="width: 140px; height: 140px; float: left; margin-right: 10px;">
                </div>
            </FormItem>
            <Row :gutter="32">
                <Col span="12">
                    <FormItem label="专家分类" prop="expertType">
                        <Select v-model="item.expertType" @on-change="change" :disabled="!item.isAdd">
                ...
                <Col span="12">
                    <FormItem label="擅长领域" prop="excelField">
                        <Input v-model="item.excelField" :clearable="item.isAdd" @on-change="change" :disabled="!item.isAdd" />
                    </FormItem>
                </Col>
            </Row>
            <Row :gutter="32">
                <Col span="12">
                    <FormItem label="擅长物种">
                        <Input v-model="item.excelSpecies" :disabled="!item.isAdd" readonly class="pinput-clear" 
                ...
                <Col span="12">
                    <FormItem label="相关物种">
                        <Input v-model="item.relatedSpecies" :disabled="!item.isAdd" readonly class="pinput-clear" 
            ...
            <Row :gutter="32">
                <Col span="12">
                    <FormItem label="相关行业" prop="relatedIndustries">
                        <Input v-model="item.relatedIndustries" :disabled="!item.isAdd" readonly class="pinput-clear" 
                ...
                <Col span="12">
                    <FormItem label="相关商品">
                        <Input v-model="item.relatedGoods" :disabled="!item.isAdd" :clearable="item.isAdd" @on-change="change" />
                    </FormItem>
                </Col>
            </Row>
            <Row :gutter="32">
                <Col span="12">
                    <FormItem label="相关服务" prop="relatedServices">
                        <Input v-model="item.relatedServices" :disabled="!item.isAdd" readonly class="pinput-clear" 
