<template>
  <vui-wrapper>
    ...
    <component slot="content" v-bind:is="mode" :id="modeId" :yearId="yearId" :appId="appId" @on-show-land="handleShowLandInfo" @on-map="handleShowMap" @on-save="onSave" :ref="mode" @left-refresh="leftRefresh"></component>
  </vui-wrapper>
</template>
