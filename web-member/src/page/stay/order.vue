  ...
  <div>
    <Row class="pt20 pb20">
        <Col span="24">
            ...
            <Button type="text" size="large" :class="[tabActive === '1' ? 't-green' : '']" @click.native="handleTabsClick('1')">未入住</Button>
            <Button type="text" size="large" :class="[tabActive === '8' ? 't-green' : '']" @click.native="handleTabsClick('8')">已入住</Button>
