    ...
    <div class="searchModal">
        ...
        <div class="container">
            <Breadcrumb separator=">" class="mt20 mb10">
                ...
                <Breadcrumb-item to="/51index/knowledgeList?flag=3">知识</Breadcrumb-item>
                ...
                <Col span="18">
                    ...
                    <Row type="flex" align="middle" class="pd10">
                       ...
                       <collect-modal ref="collectModal" @on-init="chckeCollect" v-on:collectForm="collectForm" :itemId="itemId" :itemType="itemType" :link="link" :collectTitle="collectTitle"/>
                        ...
                        <Col  span="2" push="8" style="float: right;">
                        <Button type="text" @click="jubaoAdd"><Icon type="md-information-circle" size="16"></Icon> 举报</Button>
                    ...
                    <div class="CommentTab">
                     ...
                     <Tabs value="name1"  @on-click="getMyCommnet">
                        ...
                        <Tab-pane label="最新评论" name="name1">
							<comments :data="commentList" v-if="commentList.list" @on-NextPage="handleNextPage" :dataType="'知识'"/>
						</Tab-pane>
						<Tab-pane label="我的评论" name="name2" v-if="loginuserinfo != ''">
							<comments :data="myComments" v-if="myComments.list" @on-NextPage="handleOwnerNextPage" :dataType="'知识'"/>
						</Tab-pane>
					</Tabs>
                    </div>
                </Col>
        ...
        <Modal :transfer="false" v-model="playVideoShow" @on-ok="playVideoShow=false"  title="播放视频" width="600px" height="300px" :mask-closable="false">
            <d-player ref="playerKnow"  :video="video" :loop="false"></d-player>
        </Modal>
        <div>
        </div>
    </div>
...
export default {
    ...
    created() {
        ...
        /*api.get('/member/knowLege/upvote?id=' + this.$route.query.id).then(response => {
            this.Numberofpoints = response.data.thumbUpNum
        })*/
    },
    data() {
        return {
    ...
    mounted() {
		    this.player = this.$refs.playerKnow.dp;
		   },
    computed: {
        swiper() {
    ...
    methods: {
        ...
        reply(id) {
            ...
            api.post('/member/knowLege/saveHuiFu',
                {
                    dynamicId: id,
                    comment: this.huifu,
                    account:this.$user.loginAccount
        ...
        goToPrevious(id) {
            api.get('/member/knowLege/findKnowLedgeDetail?id=' + id)
                .then(response => {
