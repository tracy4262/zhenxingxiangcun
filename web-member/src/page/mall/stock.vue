<template>
    <div class="wrapper">
                        ...
                        <div class="sub">
                            <Row>
                                ...
                                <Row v-for="(sub,index) in item.sub" :key="index" class="mt10 mb10 pr10">
                                    <Col span="3">
                                    <a href="/mall/stockDetail" class="sub-class">{{sub.text}}
                                        <i class="icon-arrow-right"></i>
                                    </a>
                                    </Col>
                                    <Col span="21" class="pb5 mb5 tl" style="border-bottom: 1px dotted #ddd;">
                                    <a v-for="link in sub.sublink" href="/mall/stockDetail" class="sub-link">{{link.text}}</a>
                                    </Col>
                                </Row>
                                </Col>
                                <Col span="6">
        ...
        <div class="hot-group-banner">
            <Carousel class="auction-bannner" v-model="carousel.value" :autoplay="carousel.autoplay" :arrow="carousel.arrow">
        ...
        <section class="layouts">
            <div class="goods-list fix-price-product">
                <div class="hd mb20">
                    <div class="fliter pd10">
                        <Row>
                            ...
                            <Col span="16" class="tr"> 共
                            <span class="t-green"> 99999 </span>件商品
                ...
                <Row :gutter="10">
                    ...
                    <a href="/mall/stockDetail" class="goods">
                        ...
                        <Row class="ma-pd5 pd5 info">
                            <Col span="24" class="h4 t-orange">￥{{item.price}}</Col>
                            <Col span="24" class="ell h6 mt5 mb10">{{item.name}}</Col>
                            <Col span="10" class="t-green">已售{{item.sell_count}}件</Col>
                            <Col span="14" class="t-green tr">好评率{{item.good_comment}}</Col>
                            <Row>
            ...
            <div class="tc">
                <Page :total="page.total" :current="page.current" :page-size="page.size" @on-change="getSpotProduct" show-elevator></Page>
            </div>
            <br>
            <br>
            <br>
...
export default {
    ...
    methods: {
        ...
        handleForward(){
            ...
            this.page.current++
            this.getSpotProduct(this.page.current)
        },
        // 前进
        handleBack(){
        ...
        getSpotProduct(cpage) {
            this.page.current = cpage;
            api.get('/member/shop/getSpotProduct?page=' + cpage + '&pageSize=' + this.page.size)
                .then(response => {
...
<style lang="scss">
body .goods-list .goods .pd5{border: 0;}
body .goods-list .goods .bd{border: 0;}
body .goods-list .goods{border: 1px solid #e3e3e3}
</style>
