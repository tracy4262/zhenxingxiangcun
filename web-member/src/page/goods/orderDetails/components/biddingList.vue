<template>
    <div class="order-contents-list">
        <Row style="background:#f7f7f7" :gutter="32"  type="flex" justify="center" align="middle">
            ...
            <Col span="3"><div class="pd10 tc">当前出价</div></Col>
            <Col span="3"><div class="pd10 tc">当前竞拍数量</div></Col>
            <Col span="3"><div class="pd10 tc">出价次数</div></Col>
            <Col span="3"><div class="pd10 tc">当前出价时间</div></Col>
            <Col span="4"><div class="pd10 tc">操作</div></Col>
        </Row>
            ...
            <div v-for="(item, index) in data" :key="index" class="mt20"  style="background:#FCFDFE">
                ...
                <div style="border:1px solid #f1f1f1;border-top:none;">
                    <Row type="flex" justify="center" align="middle">
                        ...
                        <Col span="3"><div class="pd10 tc">{{ item.bidTime }}次</div></Col>
                        <Col span="3"><div class="pd10 tc">{{ item.payTime === '' ? '——' : item.payTime }}</div></Col>
                        <Col span="4"><div class="pd10 tc"><Button type="primary" @click="detail(item)">查看商品详情</Button></div></Col>
                    </Row>
                </div>
            </div>
...
export default {
    ...
    methods: {
        init () {
            this.$api.post('/shop/shopBidding/auctioning', {
                buyerAccount: this.$user.loginAccount,
                pageNum: this.pageNum,
                pageSize: this.pageSize
            }).then(response => {
                console.log('my bidding list response', response)
