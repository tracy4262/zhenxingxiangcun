    ...
    <Row type="flex" justify="center" class="mt20">
      ...
      <div style="width:1200px">
        <Breadcrumb v-show="isShow">
          ...
          <BreadcrumbItem to="/goods/showGoods">竞价商品</BreadcrumbItem>
        </Breadcrumb>
        ...
        <ul class="goods-list" v-if="list!=null">
          ...
          >
            <div v-if="item.biddingEndTimeStr.length != 0 && new Date(item.biddingEndTimeStr).getTime() > new Date().getTime()" class="clocker">
              距离结束还剩：
...
export default {
  ...
  methods: {
    ...
    searchBtn() {
      this.$api
        .post("/shop/pushShopCommodity/findBidding", {
