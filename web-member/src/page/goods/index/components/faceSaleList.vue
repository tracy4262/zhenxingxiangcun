    ...
    <Row type="flex" justify="center" class="mt20">
      ...
      <div style="width:1200px">
        <Breadcrumb v-show="isShow">
          ...
          <BreadcrumbItem to="/goods/showGoods">面议商品</BreadcrumbItem>
        </Breadcrumb>
        ...
        <ul class="goods-list" v-if="list!=null">
          ...
          >
            <!-- <div
              v-if="item.groupBuyingEndTime != '' && item.groupBuyingEndTime != undefined"
              class="clocker"
            >
              距离结束还剩：
              <vui-clocker :time="item.groupBuyingEndTime" format="%D天 %H小时 %M分 %S秒"/>
            </div> -->
...
export default {
  ...
  methods: {
    ...
    searchBtn() {
      this.$api
        .post("/shop/pushShopCommodity/findFace", {
