<template>
    <div class="pt30 pl10 pr10 sales">
        <Form ref="data" :model="data" label-position="left" :label-width="120" :rules="ruleInline">
            ...
            <Row :gutter="32">
                <Col span="12">
                    <Form-item prop="startTimeStr" label="有效期开始时间">
                ...
                <Col span="12">
                    <Form-item prop="endTimeStr" label="有效期截止时间">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleSubmit () {
                if (this.data.startTime) {
                    this.data.startTime = this.moment(this.data.startTime).format('YYYY-MM-DD HH:mm')
                }
                if (this.data.endTime) {
                    this.data.endTime = this.moment(this.data.endTime).format('YYYY-MM-DD HH:mm')
                }
