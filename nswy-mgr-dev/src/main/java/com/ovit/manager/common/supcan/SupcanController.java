package com.ovit.manager.common.supcan;
...
import com.ovit.manager.common.supcan.annotation.treelist.SupTreeList;
import com.ovit.manager.common.supcan.annotation.treelist.cols.SupCol;
import com.ovit.manager.common.supcan.annotation.treelist.cols.SupGroup;
import com.ovit.manager.common.supcan.treelist.TreeList;
import com.ovit.manager.common.supcan.treelist.cols.Col;
import com.ovit.manager.common.supcan.treelist.cols.Group;
...
public class SupcanController extends BaseController {
	 ...
	 * @param parentId
	 */
	private void listToTree(List<Object> colList, Map<String, Group> groupMap, String parentId,
