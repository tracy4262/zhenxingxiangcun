package com.ovit.manager.common.supcan.common.properties;

import java.util.List;

import com.google.common.collect.Lists;
import com.ovit.manager.common.supcan.annotation.common.properties.SupExpress;
import com.ovit.manager.common.supcan.annotation.common.properties.SupProperties;
import com.ovit.manager.common.utils.ObjectUtils;
...
public class Properties {
	 ...
	 * "C0D0E0" 是 RGB, 此外, 还支持包含如下边框属性： borderWidth - 边框线宽 borderColor - 边框线色
	 * borderRound - 边框线的圆角直径 示例: "#12FFFFFF,#22EEFFEE; borderWidth=1;
	 * borderColor=red; borderRound=8"
	 */
	@XStreamAsAttribute
	private String curSelBgColor = "#F5F5F5,#EDEDED"; // #F5F5F5 #FFE88D

	/**
	 * 整行的背景色、文字色表达式 表达式, 如: displayMask = "bgColor=if(price=0, red,
	 * transparent); textColor=if(price>2,#000022, blue)"
	 */
	@XStreamAsAttribute
