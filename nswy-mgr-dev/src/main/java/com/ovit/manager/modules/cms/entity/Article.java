...
public class Article extends DataEntity<Article> {
	...
	private String businessInformation;//商务资讯
	private String allRange;//所有范围
	private String businessNature;//行业性质
	private String allBusiness;//所有行业
    private String customContentView;	// 自定义内容视图
   	private String viewConfig;	// 视图参数

	private ArticleData articleData;	//文章副表
	private IndustrialClassified industrialClassified;//行业分类
	...
	public IndustrialClassified getIndustrialClassified() {
		return industrialClassified;
	}

	public void setIndustrialClassified(IndustrialClassified industrialClassified) {
		this.industrialClassified = industrialClassified;
	}
