...
<form:form id="inputForm" modelAttribute="dictionaryMetalMinerals"  action="${ctx}/nswy/dictionaryMetalMinerals/save" method="post" class="form-horizontal" enctype="multipart/form-data">
