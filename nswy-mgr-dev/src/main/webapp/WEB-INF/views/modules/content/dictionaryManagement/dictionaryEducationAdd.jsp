...
<form:form id="inputForm" modelAttribute="dictionaryEducation"  action="${ctx}/nswy/dictionaryEducation/save" method="post" class="form-horizontal" enctype="multipart/form-data">
