...
<form:form id="inputForm"  modelAttribute="generalServiceInfo" action="${ctx}/nswy/generalService/updateGeneralService" method="post" class="form-horizontal" enctype="multipart/form-data">
    <form:hidden path="serviceId"/>

    <div class="control-group">
        <label class="control-label">通用服务名称:</label>
        <div class="controls">
