...
<form:form id="inputForm" modelAttribute="dictionaryProtectionLevel"  action="${ctx}/nswy/dictionaryProtectionLevel/save" method="post" class="form-horizontal" enctype="multipart/form-data">
