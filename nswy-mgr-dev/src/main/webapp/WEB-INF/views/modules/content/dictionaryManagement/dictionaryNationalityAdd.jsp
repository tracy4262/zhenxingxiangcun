...
<form:form id="inputForm" modelAttribute="dictionaryNationality"  action="${ctx}/nswy/dictionaryNationality/save" method="post" class="form-horizontal" enctype="multipart/form-data">
