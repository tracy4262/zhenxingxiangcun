...
<form:form id="inputForm" modelAttribute="dictionaryPartisan"  action="${ctx}/nswy/dictionaryPartisan/save" method="post" class="form-horizontal" enctype="multipart/form-data">
