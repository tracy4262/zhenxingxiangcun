...
<form:form id="inputForm" modelAttribute="dictionaryAgencyLevel"  action="${ctx}/nswy/dictionaryAgencyLevel/save" method="post" class="form-horizontal" enctype="multipart/form-data">
