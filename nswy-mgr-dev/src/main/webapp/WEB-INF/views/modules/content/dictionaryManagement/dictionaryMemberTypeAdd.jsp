...
<form:form id="inputForm" modelAttribute="dictionaryMemberType"  action="${ctx}/nswy/dictionaryMemberType/save" method="post" class="form-horizontal" enctype="multipart/form-data">
