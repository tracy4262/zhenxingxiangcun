...
<form:form id="inputForm" modelAttribute="dictionaryWaterGasMinerals"  action="${ctx}/nswy/dictionaryWaterGasMinerals/save" method="post" class="form-horizontal" enctype="multipart/form-data">
