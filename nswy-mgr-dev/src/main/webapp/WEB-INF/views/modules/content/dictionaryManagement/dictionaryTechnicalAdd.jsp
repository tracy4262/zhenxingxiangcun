...
<ul class="nav nav-tabs">
	...
	<li>
		<a href="${ctx}/nswy/dictionaryTechnical/control">职称列表</a>
	</li>
	<li class="active">
		<a >职称添加</a>
	</li>
...
<form:form id="inputForm" modelAttribute="dictionaryTechnical"  action="${ctx}/nswy/dictionaryTechnical/save" method="post" class="form-horizontal" enctype="multipart/form-data">
