...
<form:form id="inputForm" modelAttribute="dictionaryColumn"  action="${ctx}/nswy/dictionaryColumn/save" method="post" class="form-horizontal" enctype="multipart/form-data">
