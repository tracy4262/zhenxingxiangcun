...
<ul class="nav nav-tabs">
	...
	<li>
		<a href="${ctx}/nswy/dictionaryLandUse/control">土地列表</a>
	</li>
	<li class="active">
		<a >土地添加</a>
	</li>
...
<form:form id="inputForm" modelAttribute="dictionaryLandUse"  action="${ctx}/nswy/dictionaryLandUse/save" method="post" class="form-horizontal" enctype="multipart/form-data">
