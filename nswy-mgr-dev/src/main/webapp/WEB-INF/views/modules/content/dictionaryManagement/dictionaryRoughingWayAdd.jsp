...
<form:form id="inputForm" modelAttribute="dictionaryRoughingWay"  action="${ctx}/nswy/dictionaryRoughingWay/save" method="post" class="form-horizontal" enctype="multipart/form-data">
