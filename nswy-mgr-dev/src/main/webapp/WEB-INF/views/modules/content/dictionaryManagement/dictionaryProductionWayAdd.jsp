...
<form:form id="inputForm" modelAttribute="dictionaryProductionWay"  action="${ctx}/nswy/dictionaryProductionWay/save" method="post" class="form-horizontal" enctype="multipart/form-data">
