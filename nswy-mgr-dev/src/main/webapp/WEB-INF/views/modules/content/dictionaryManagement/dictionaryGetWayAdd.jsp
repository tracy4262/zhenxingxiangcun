...
<form:form id="inputForm" modelAttribute="dictionaryGetWay"  action="${ctx}/nswy/dictionaryGetWay/save" method="post" class="form-horizontal" enctype="multipart/form-data">
