...
<form:form id="inputForm" modelAttribute="dictionaryTown"  action="${ctx}/nswy/dictionaryTown/save" method="post" class="form-horizontal" enctype="multipart/form-data">
