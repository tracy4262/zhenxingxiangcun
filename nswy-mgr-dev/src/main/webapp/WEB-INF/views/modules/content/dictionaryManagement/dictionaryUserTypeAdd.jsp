...
<form:form id="inputForm" modelAttribute="dictionaryUserType"  action="${ctx}/nswy/dictionaryUserType/save" method="post" class="form-horizontal" enctype="multipart/form-data">
