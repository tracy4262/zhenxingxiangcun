...
<form:form id="inputForm" modelAttribute="dictionaryEnergyMinerals"  action="${ctx}/nswy/dictionaryEnergyMinerals/save" method="post" class="form-horizontal" enctype="multipart/form-data">
