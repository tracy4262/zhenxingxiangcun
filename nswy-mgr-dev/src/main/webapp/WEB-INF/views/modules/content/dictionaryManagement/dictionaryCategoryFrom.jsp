...
<ul class="nav nav-tabs">
	...
	<li >
		<a href="${ctx}/nswy/dictionaryCategory/control">行业列表</a>
	</li>
	<li class="active">
		<a >行业修改</a>
	</li>
...
<form:form id="inputForm"  modelAttribute="dictionaryCategory" action="${ctx}/nswy/dictionaryCategory/updateCategory" method="post" class="form-horizontal" enctype="multipart/form-data">
	<form:hidden path="id"/>
