...
<form:form id="inputForm" modelAttribute="dictionaryPoliticalStatus"  action="${ctx}/nswy/dictionaryPoliticalStatus/save" method="post" class="form-horizontal" enctype="multipart/form-data">
