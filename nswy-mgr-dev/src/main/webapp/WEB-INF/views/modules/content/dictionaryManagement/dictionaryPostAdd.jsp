...
<form:form id="inputForm" modelAttribute="dictionaryPost"  action="${ctx}/nswy/dictionaryPost/save" method="post" class="form-horizontal" enctype="multipart/form-data">
