...
<form:form id="inputForm" modelAttribute="dictionaryClimateType"  action="${ctx}/nswy/dictionaryClimateType/save" method="post" class="form-horizontal" enctype="multipart/form-data">
