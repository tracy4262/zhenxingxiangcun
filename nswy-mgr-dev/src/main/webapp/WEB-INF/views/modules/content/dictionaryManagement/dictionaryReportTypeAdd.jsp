...
<form:form id="inputForm" modelAttribute="dictionaryReportType"  action="${ctx}/nswy/dictionaryReportType/save" method="post" class="form-horizontal" enctype="multipart/form-data">
