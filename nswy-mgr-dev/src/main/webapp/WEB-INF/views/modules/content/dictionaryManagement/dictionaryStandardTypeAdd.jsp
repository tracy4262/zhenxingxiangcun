...
<form:form id="inputForm" modelAttribute="dictionaryStandardType"  action="${ctx}/nswy/dictionaryStandardType/save" method="post" class="form-horizontal" enctype="multipart/form-data">
