...
<form:form id="inputForm" modelAttribute="dictionaryFacility"  action="${ctx}/nswy/dictionaryFacility/save" method="post" class="form-horizontal" enctype="multipart/form-data">
