<%@ page contentType="text/html;charset=UTF-8" %>
       ...
       <body>
       	<form action="${ctx}/nswy/updateSpeciesPest" method="post" class="form-horizontal">
			...
			<div class="control-group">
				<label >形态特征:</label>
				<div>${species.fmainfeatures}</div>
			</div>
       		<div class="control-group">
			<label>危害症状:</label>
			<div>${species.fhabit}</div>
		</div>
			<div class="control-group">
				<label>危害物种:</label>
