...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/nswy/proxyCorpInfoForm?id=${proxyCropInfo.id}">代理管理审核</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="proxyCropInfo" action="${ctx}/nswy/updateProxyCorpInfo" method="post" class="form-horizontal">
		<input type="hidden" name="proxyCorpInfoId" value="${proxyCorpInfo.id}" />
