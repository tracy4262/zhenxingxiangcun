    ...
    <script type="text/javascript">
        ...
        function isHomeDisplay(id) {
            ...
            if (confirmStatus) {
                $.ajax({
                    type : 'POST',
                    url : '${ctx}/nswy/knowledge/update-home',
                    data : {
                        status : status,
                        id : id
                    },
        ...
        function isNavDisplay(id) {
            ...
            if (confirmStatus) {
                $.ajax({
                    type : 'POST',
                    url : '${ctx}/nswy/knowledge/update-nav-display',
                    data : {
                        status : status,
                        id : id
                    },
        ...
        function setOrderNum(id) {
            ...
            $.ajax({
                type : 'POST',
                url : '${ctx}/nswy/knowledge/set-order-num',
                data : {
                    orderNum : orderNum,
                    id : id
                },
...
<body>
<form:form id="searchForm"  modelAttribute="knowledgeInfo"  action="${ctx}/nswy/knowledge/examine" method="post" class="breadcrumb form-search">
...
<%--        <th>无忧首页是否显示</th>
    ...
    <c:forEach items="${page.list}" var="item">
        <tr>
            ...
            <td>
                <input type="checkbox" align="center" id="isNavDisplay${item.id}" value="" ${item.isNavDisplay eq '0' ? 'checked' : ''} onclick="isNavDisplay('${item.id}')"/>
            </td>
            <td>
